...
SECRET_KEY = "6ti5x&7psmbw6sb_9e2t3p_7a06%qk#(njn7($ng*iyoah!l3@"
...
MIDDLEWARE = [
    "corsheaders.middleware.CorsMiddleware", # added for this project
...
# Custom user model
AUTH_USER_MODEL = "useraccess.SchedulerUser"